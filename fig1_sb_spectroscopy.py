...
# ----------------------------------------------------------------------
# Save output (run from the repository root, same convention as fig2-fig4)
# ----------------------------------------------------------------------
import os
os.makedirs("output", exist_ok=True)
fig.savefig("output/fig1_sb_spectroscopy.pdf", dpi=300, bbox_inches="tight")
fig.savefig("output/fig1_sb_spectroscopy.png", dpi=300, bbox_inches="tight")
